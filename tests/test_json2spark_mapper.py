...
class TestMappings(unittest.TestCase):
    ...
    def test_simple_object_type_schema(self):
        ...
        simple_object = struct_type.fields[struct_type.fieldNames().index("simpleObjectValue")]
        ...
        self.assertTrue(len(simple_object_data_type.fields) == 3)
        self.assertEqual((simple_object_data_type[simple_object_data_type.fieldNames().index("stringValue")]).dataType, StringType())
        self.assertEqual((simple_object_data_type[simple_object_data_type.fieldNames().index("intValue")]).dataType, LongType())
        self.assertEqual((simple_object_data_type[simple_object_data_type.fieldNames().index("boolValue")]).dataType, BooleanType())
    ...
    def test_complex_object_type_schema(self):
        ...
        # compare type name, because instances will have different content
        complex_object = struct_type.fields[struct_type.fieldNames().index("complexObjectValue")]
        self.assertEqual(complex_object.dataType.typeName, StructType().typeName)
        simple_object_data_type = complex_object.dataType
        # Check nested properties
        self.assertTrue(len(simple_object_data_type.fields) == 3)
        
        string_value = simple_object_data_type[simple_object_data_type.fieldNames().index("stringValue")]
        self.assertEqual(string_value.dataType, StringType())
        self.assertTrue(string_value.nullable)
        
        array_value = (simple_object_data_type[simple_object_data_type.fieldNames().index("arrayValue")])
        self.assertEqual(array_value.dataType, ArrayType(StringType()))
        self.assertTrue(array_value.nullable)
        
        nested_object_value = simple_object_data_type[simple_object_data_type.fieldNames().index("nestedObjectValue")]
        # compare type name, because instances will have different content
    ...
    def test_simple_array_type_schema(self):
        ...
        self.assertTrue(len(struct_type.fields) == 1)
        # compare type name, because instances will have different content
        simple_array = struct_type.fields[struct_type.fieldNames().index("simpleArrayValue")]
    ...
    def test_complex_array_type_schema(self):
        ...
        self.assertTrue(len(struct_type.fields) == 1)
        # compare type name, because instances will have different content
        complex_array = struct_type.fields[struct_type.fieldNames().index("complexArrayValue")]
        self.assertEqual(complex_array.dataType.typeName, ArrayType(elementType=StringType()).typeName) # ArrayType needs an init paramter
        # Check elementType properties
        # TODO: fix test
    ...
    def test_required_simple_fields(self):
        ...
        string_value_type = struct_type.fields[struct_type.fieldNames().index("stringValue")]
        self.assertEqual(string_value_type.dataType, StringType())
        self.assertFalse(string_value_type.nullable)
        
        number_value_type = struct_type.fields[struct_type.fieldNames().index("numberValue")]
        self.assertEqual(number_value_type.dataType, DoubleType())
        self.assertFalse(number_value_type.nullable)
        
        integer_value_type = struct_type.fields[struct_type.fieldNames().index("integerValue")]
        self.assertEqual(integer_value_type.dataType, LongType())
        self.assertFalse(integer_value_type.nullable)
        
        boolean_value_type = struct_type.fields[struct_type.fieldNames().index("booleanValue")]
    ...
    def test_required_complex_fields(self):
        ...
        # Test Object
        object_value_type = struct_type.fields[struct_type.fieldNames().index("objectValue")]
        ...
        nested_string_value = object_value_type_data_type[object_value_type_data_type.fieldNames().index("nestedStringValue")]
        self.assertEqual(nested_string_value.dataType, StringType())
        self.assertFalse(nested_string_value.nullable)
        
        nested_number_value = object_value_type_data_type[object_value_type_data_type.fieldNames().index("nestedNumberValue")]
        ...
        self.assertEqual(array_value.dataType.typeName, ArrayType(elementType=StructType()).typeName)
        ...
        required_string_value = array_item_type[array_item_type.fieldNames().index("requiredStringValue")]
        self.assertEqual(required_string_value.dataType, StringType())
        self.assertFalse(required_string_value.nullable)
        
        optional_string_value = array_item_type[array_item_type.fieldNames().index("optionalStringValue")]
